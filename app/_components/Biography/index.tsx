      ...
      <div className="p-4">
        <ul className="border-l-4 border-slate-400">
          ...
          <li className="relative -ml-2 min-h-32 pb-7 pl-7 before:absolute before:-top-1 before:left-0 before:h-3 before:w-3 before:rounded-xl before:bg-slate-400">
            ...
            <p className="pt-4">
              大手のWeb制作会社にアルバイトとして勤務。大企業のWebページの量産、改修に携わり自分の書いたコードが多くの人に閲覧されることを経験し、Webが与える影響力を肌で実感しました。
              <br />
              影響力を実感する中で、そのWebのリソースにアクセスしづらい人の目線も意識するようになりWebアクセシビリティを意識するようにもなりました。
            </p>
          </li>
        </ul>
      </div>
